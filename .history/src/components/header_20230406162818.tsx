...
function Header() {
  return (
    <div className="h-[80px]  px-10 sm:none bg-green-700 flex items-center ">
...
Assuming you have a `Header` component, you can use CSS `position: fixed` property along with some JavaScript logic to achieve this effect. Here's an example:
