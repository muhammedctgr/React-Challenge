    ...
    <div className="bg-gray-100  p-10">
      ...
      <div className="my-10 divide-y">
        <div className="flex justify-between   text-sm text-gray-500  py-5">
          <p>Subtotal</p>
          <p>{currencyFormatter(subTotal, "USD")}</p>
        </div>
        <div className="flex justify-between   text-sm text-gray-500 py-5 ">
          <p>Shipping Estimate</p>
          <p>{currencyFormatter(shippingEstimate, "USD")}</p>
        </div>
        <div className="flex justify-between   text-sm text-gray-500  py-5">
          <p>Tax Estimate</p>
          <p>{currencyFormatter(taxEstimate, "USD")}</p>
        </div>
      ...
      <Button className="bg-green-600 hover:bg-indigo-700 text-white  w-full">
        Checkout
      </Button>
    </div>
  );
